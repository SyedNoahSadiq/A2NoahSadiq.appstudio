...
const cacheName = 'A2NoahSadiq_appstudio-2021-02-28 20:15:37.628608'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2NoahSadiq_appstudio'.length) === 'A2NoahSadiq_appstudio') {
